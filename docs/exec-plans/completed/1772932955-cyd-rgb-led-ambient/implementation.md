...
- `docs/references/testing-checklist.md` — Added 8 LED ambient testing items
...
5. **[T3] Testing checklist** — Added 8 observable-behavior test items to `docs/references/testing-checklist.md`
