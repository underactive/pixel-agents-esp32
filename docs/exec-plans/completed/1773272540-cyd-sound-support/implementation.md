...
- `docs/HISTORY.md` — Updated 0.9.0 row to include CYD sound support.
- `docs/references/testing-checklist.md` — Added 7 CYD-specific sound test items, updated section title from "CYD-S3 Only" to "CYD and CYD-S3".
