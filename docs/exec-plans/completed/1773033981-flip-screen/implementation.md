...
5. Added 8 manual test items to `docs/references/testing-checklist.md` covering flip screen toggle, persistence, touch correctness, and screenshots (addresses T1-T8, T10)
