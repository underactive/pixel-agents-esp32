...
- **Modified:** `docs/HISTORY.md` — Added v0.7.0 entry
- **Modified:** `docs/references/testing-checklist.md` — Added Boot Splash Screen test section
- **Modified:** `docs/exec-plans/tech-debt-tracker.md` — Marked "Boot animation" as done
...
- `docs/references/testing-checklist.md` — added splash screenshot, footer, and fade test items
