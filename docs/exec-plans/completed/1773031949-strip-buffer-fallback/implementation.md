...
- `docs/exec-plans/tech-debt-tracker.md` -- Marked strip-buffer item as complete
...
8. **Testing checklist** (T-3) — Added 10 strip-buffer rendering test items to `docs/references/testing-checklist.md`.
