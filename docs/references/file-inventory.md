...
Complete file and directory listing for the Pixel Agents ESP32 project. Referenced from `AGENTS.md`.
...
| `AGENTS.md` | Agent routing table: orientation, conventions, workflow |
| `ARCHITECTURE.md` | System design, domains, build config, external integrations |
| `CLAUDE.md` | Claude-specific agent guidance |
| `GEMINI.md` | Gemini-specific agent guidance |
| `README.md` | User-facing project documentation |
| `CHANGELOG.md` | User-facing changelog (Keep a Changelog format) |
| `LICENSE` | Project license |
| `.github/workflows/release.yml` | GitHub Actions release workflow |
| `docs/PLANS.md` | Planning framework and completed plans index |
| `docs/HISTORY.md` | Phase-based project evolution timeline |
| `docs/QUALITY_SCORE.md` | Letter grades (A-F) per domain |
| `docs/RELIABILITY.md` | Failure modes, system guarantees, known limitations |
| `docs/SECURITY.md` | Threat model, technical controls, sensitive resources |
| `docs/DESIGN.md` | Output conventions and UI patterns |
| `docs/PRODUCT_SENSE.md` | User personas and product principles |
| `docs/design-docs/index.md` | Design decision index |
| `docs/design-docs/core-beliefs.md` | 8 foundational development rules |
| `docs/product-specs/index.md` | Product specification catalog |
| `docs/product-specs/_template.md` | User story template |
| `docs/exec-plans/active/` | In-progress execution plans |
| `docs/exec-plans/completed/` | Completed execution plans (38 epoch-prefixed directories) |
| `docs/exec-plans/tech-debt-tracker.md` | Tech debt and future enhancement inventory |
| `docs/references/subsystems.md` | Detailed subsystem specifications |
| `docs/references/hardware.md` | Pin assignments and component details |
| `docs/references/audit-checklist.md` | Post-implementation audit process and checklist |
| `docs/references/testing-checklist.md` | QA testing checklist |
| `docs/references/common-modifications.md` | Step-by-step recipes for frequent changes |
| `docs/references/file-inventory.md` | This file |
| `docs/generated/README.md` | Auto-generated schema directory |
