...
| `docs/CLAUDE.md/testing-checklist.md` | T1, T2 |
...
**[FIXED] T1 (critical): No wake word testing items in checklist** (`docs/CLAUDE.md/testing-checklist.md`)
...
**[FIXED] T2 (warning): Mic test removal not verified in checklist** (`docs/CLAUDE.md/testing-checklist.md`)
