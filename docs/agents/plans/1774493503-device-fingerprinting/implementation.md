...
- `docs/agents/subsystems.md` — Added IDENTIFY_REQ/RSP to protocol message table, updated BLE TX description
- `docs/agents/testing-checklist.md` — Added Device Fingerprinting test section
- `docs/agents/PROJECT.md` — Updated message type count from 8 to 10
