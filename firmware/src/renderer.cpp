...
void Renderer::drawFurniture() {
    ...
    drawRGB565Sprite(11 * TILE_SIZE, 13 * TILE_SIZE, SPRITE_PLANT_BOTTOM_BROWN, SPRITE_PLANT_BOTTOM_BROWN_W, SPRITE_PLANT_BOTTOM_BROWN_H);
    ...
    drawRGB565Sprite(11 * TILE_SIZE, 12 * TILE_SIZE, SPRITE_PLANT_TOP_D, SPRITE_PLANT_TOP_D_W, SPRITE_PLANT_TOP_D_H);
