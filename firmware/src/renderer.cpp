...
void Renderer::drawFurniture() {
    ...
    drawRGB565Sprite(1 * TILE_SIZE, 8 * TILE_SIZE, SPRITE_DESK_D, SPRITE_DESK_D_W, SPRITE_DESK_D_H);
    drawRGB565Sprite(6 * TILE_SIZE, 8 * TILE_SIZE, SPRITE_DESK_D, SPRITE_DESK_D_W, SPRITE_DESK_D_H);
    drawRGB565Sprite(1 * TILE_SIZE, 5 * TILE_SIZE, SPRITE_DESK_D, SPRITE_DESK_D_W, SPRITE_DESK_D_H);
    drawRGB565Sprite(6 * TILE_SIZE, 5 * TILE_SIZE, SPRITE_DESK_D, SPRITE_DESK_D_W, SPRITE_DESK_D_H);
    ...
    drawRGB565Sprite(2 * TILE_SIZE, 9 * TILE_SIZE, SPRITE_CHAIR_B, SPRITE_CHAIR_B_W, SPRITE_CHAIR_B_H);
    drawRGB565Sprite(7 * TILE_SIZE, 9 * TILE_SIZE, SPRITE_CHAIR_B, SPRITE_CHAIR_B_W, SPRITE_CHAIR_B_H);
    drawRGB565Sprite(2 * TILE_SIZE, 4 * TILE_SIZE, SPRITE_CHAIR_A, SPRITE_CHAIR_A_W, SPRITE_CHAIR_A_H);
    drawRGB565Sprite(7 * TILE_SIZE, 4 * TILE_SIZE, SPRITE_CHAIR_A, SPRITE_CHAIR_A_W, SPRITE_CHAIR_A_H);
    ...
    drawRGB565Sprite(10 * TILE_SIZE, 13 * TILE_SIZE, SPRITE_PLANT_BOTTOM_BROWN, SPRITE_PLANT_BOTTOM_BROWN_W, SPRITE_PLANT_BOTTOM_BROWN_H);
    ...
    drawRGB565Sprite(10 * TILE_SIZE, 12 * TILE_SIZE, SPRITE_PLANT_TOP_D, SPRITE_PLANT_TOP_D_W, SPRITE_PLANT_TOP_D_H);
    ...
    drawRGB565Sprite(13 * TILE_SIZE, 9 * TILE_SIZE, SPRITE_SEAT_3, SPRITE_SEAT_3_W, SPRITE_SEAT_3_H);
    drawRGB565Sprite(13 * TILE_SIZE, 11 * TILE_SIZE, SPRITE_SEAT_3, SPRITE_SEAT_3_W, SPRITE_SEAT_3_H);
    ...
    drawRGB565Sprite(14 * TILE_SIZE, 7 * TILE_SIZE, SPRITE_PLANT_TOP_G, SPRITE_PLANT_TOP_G_W, SPRITE_PLANT_TOP_G_H);
    drawRGB565Sprite(14 * TILE_SIZE, 8 * TILE_SIZE, SPRITE_PLANT_BOTTOM_WHITE, SPRITE_PLANT_BOTTOM_WHITE_W, SPRITE_PLANT_BOTTOM_WHITE_H);
    drawRGB565Sprite(18 * TILE_SIZE, 7 * TILE_SIZE, SPRITE_PLANT_TOP_G, SPRITE_PLANT_TOP_G_W, SPRITE_PLANT_TOP_G_H);
    drawRGB565Sprite(18 * TILE_SIZE, 8 * TILE_SIZE, SPRITE_PLANT_BOTTOM_WHITE, SPRITE_PLANT_BOTTOM_WHITE_W, SPRITE_PLANT_BOTTOM_WHITE_H);
    ...
    drawRGB565Sprite(2 * TILE_SIZE, 7 * TILE_SIZE, SPRITE_LAPTOP_B, SPRITE_LAPTOP_B_W, SPRITE_LAPTOP_B_H);
    drawRGB565Sprite(7 * TILE_SIZE, 7 * TILE_SIZE, SPRITE_COMPUTER_B, SPRITE_COMPUTER_B_W, SPRITE_COMPUTER_B_H);
    drawRGB565Sprite(7 * TILE_SIZE, 4 * TILE_SIZE, SPRITE_COMPUTER_F, SPRITE_COMPUTER_F_W, SPRITE_COMPUTER_F_H);
    drawRGB565Sprite(2 * TILE_SIZE, 5 * TILE_SIZE, SPRITE_LAPTOP_E, SPRITE_LAPTOP_E_W, SPRITE_LAPTOP_E_H);
    drawRGB565Sprite(1 * TILE_SIZE, 1 * TILE_SIZE, SPRITE_BOXES_1, SPRITE_BOXES_1_W, SPRITE_BOXES_1_H);
    drawRGB565Sprite(4 * TILE_SIZE, 1 * TILE_SIZE, SPRITE_BOXES_2, SPRITE_BOXES_2_W, SPRITE_BOXES_2_H);
    drawRGB565Sprite(6 * TILE_SIZE, 2 * TILE_SIZE, SPRITE_BOX, SPRITE_BOX_W, SPRITE_BOX_H);
