...
- `firmware/src/config.h` -- derived defines (`HAS_LED`, `HAS_SOUND`, `SOUND_DAC_INTERNAL`, `SOUND_HAS_AMP_ENABLE`, `LED_TYPE_PWM`, `LED_TYPE_NEOPIXEL`) set from board selection
